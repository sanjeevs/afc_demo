...
class SuppliesControllerTest < ActionController::TestCase
  ...
  test "should create supply" do
    assert_difference('Supply.count') do
      post :create, supply: { adjust: @supply.adjust, amount: @supply.amount, name: @supply.name, unit: @supply.unit }
    end
  ...
  test "should update supply" do
    patch :update, id: @supply, supply: { adjust: @supply.adjust, amount: @supply.amount, name: @supply.name, unit: @supply.unit }
    assert_redirected_to supply_path(assigns(:supply))
  end
