...
class ProducersControllerTest < ActionController::TestCase
  ...
  test "should create producer" do
    assert_difference('Producer.count') do
      post :create, producer: { address: @producer.address, email: @producer.email, name: @producer.name, phone: @producer.phone }
    end
  ...
  test "should update producer" do
    patch :update, id: @producer, producer: { address: @producer.address, email: @producer.email, name: @producer.name, phone: @producer.phone }
    assert_redirected_to producer_path(assigns(:producer))
  end
